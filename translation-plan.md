...
Approach and priorities for foreign-language editions of *What Rain Feels Like*. The English edition is published (2026-09-10). The German edition (v2, native pass done) and the Romanian edition (v1, written natively) are complete — 55 chapters and the book-matter each — built as EPUBs (`build/de/`, `build/ro/`) and with their native readers. This file is the roadmap for that review and for the languages after it.
...
- [x] **German:** all 55 chapters + book-matter, v3 after the §9 revision pass (2026-09-12; `translations/de/`, notes in `REVIEW-NOTES.md`, decisions in `NOTES.md`, echo guard `ECHOES.snapshot.json`). [x] **French:** all 55 chapters + book-matter, written natively with §9 folded in (2026-09-12; `translations/fr/`). [x] **Romanian:** all 55 chapters + book-matter, written natively (2026-09-11; `translations/ro/`). [x] **Hungarian:** all 55 chapters + book-matter, written natively with the §9 rewrite folded in (2026-09-11; `translations/hu/`). Other languages: [ ] AI draft of all 55 chapters + book-matter (dedication/epigraph/acknowledgments if written, blurb, bio). The half-title, title page and **copyright page are generated** — the rights page comes out in the edition's own language from `tools/bookbuild/boilerplate.py`, so no one hand-translates it.
- [ ] Native-speaker review pass (voice, idiom, the motifs above). **German: the v3 EPUB is with the reader; §H of `NOTES.md` lists the 13 open questions. Romanian: §H lists 12. Hungarian: the EPUB is with the reader; §H lists 10. French: §H lists 10, plus the cover-comma question.**
- [x] **German title fixed: „Wie sich Regen anfühlt“** (with the closing line, one decision — `NOTES.md` §A). [x] **Romanian title fixed: „Cum se simte ploaia“** (§A). [x] **Hungarian title fixed: „Milyen érzés az eső“** (§A). Other languages: [ ] re-check the title — translate vs keep English. ("Petrichor" chapter title and the Institut name should stay, per the book's own logic.)
- [x] German blurb translated (`translations/de/book-matter/blurb.md`; the KDP description is generated from it). [x] Romanian blurb (`translations/ro/book-matter/blurb.md`). [x] Hungarian blurb (`translations/hu/book-matter/blurb.md`). Other languages: [ ]
