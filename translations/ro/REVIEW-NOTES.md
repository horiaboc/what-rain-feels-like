# Romanian edition — review notes (v1)

Collected from the `<!-- NOTES -->` trailers of every chapter and book-matter file (the build strips them). Written natively with the TRANSLATION-PROMPT §7/§8 passes folded into each chapter. Fixed decisions and the glossary: `NOTES.md`; open questions: its §H.
